...
info = {"Participant nummer":0, "Participant naam":"Onbekend", "Gender":["M", "V", "X"],"Leeftijd":0, "Handvoorkeur":["Rechtshandig", "Linkshandig", "Ambidexter"]}
already_exists = True 
...
win2 = visual.Window(size = [500,500], fullscr = False)
...
keyboard = io.devices.keyboard #is keyboard already defined somewhere else? 
...
display = io.devices.display 
tracker = io.devices.tracke

## end of eye tracking stuff ##

# open the experiment window (Fullscreen)
win = visual.Window(size = [500,500], units = 'pix', fullscr = True)

# start the clock for the internal timer of the stimulus pc
...
CuePractice = ( "Wat is de betekennis van deze aanwijzing? \n\n" +
                "Druk op \"1\" als je denkt dat deze aanwijzing betekent dat de volgende trial \"moeilijk\" en de beloning voor een juist antwoord hoog zal zijn.\n" +
                "Druk op \"2\" als je denkt dat deze aanwijzing betekent dat de volgende trial \"moeilijk\" en de beloning voor een juist antwoord laag zal zijn.\n" +
                "Druk op \"3\" als je denkt dat deze aanwijzing betekent dat de volgende trial \"makkelijk\" en de beloning voor een juist antwoord hoog zal zijn.\n" +
                "Druk op \"4\" als je denkt dat deze aanwijzing betekent dat de volgende trial \"makkelijk\" en de beloning voor een juist antwoord laag zal zijn.\n")
...
def showCueAndText(message_text = "", response_keys = ["left", "right"], height = None, color = "white",  posText = (0.0, 0.0), posImage = (0.0, 0.0), image = "None"):
...
def perform_Stroop_trial():
    ...
    message(message_text = "+", duration = 0.5)
    
    # present the thermometer cue
    showImage(duration = 1.5)
    ...
    keys = event.waitKeys(keyList = ["d","f","j","k","escape","tab"], maxWait = 3)
...
# display the 4 different cue's and let them answer what it is, repeat if accuracy = 1.0
